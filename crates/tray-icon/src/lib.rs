...
impl TrayIcon {
    ...
    pub fn new(attrs: TrayIconAttributes) -> Result<Self> {
        ...
        Ok(Self {
            tray: Arc::new(Mutex::new(platform_impl::TrayIcon::new(
                id.clone(),
                attrs,
            )?)),
            id,
    ...
    pub fn set_icon(&mut self, icon: Option<Icon>) -> Result<()> {
        self.tray.borrow_mut().lock().unwrap().set_icon(icon)
    }
    ...
    pub fn set_menu(&mut self, menu: Option<Box<dyn menu::ContextMenu>>) {
        self.tray.borrow_mut().lock().unwrap().set_menu(menu)
    }
    ...
    pub fn set_tooltip<S: AsRef<str>>(&mut self, tooltip: Option<S>) -> Result<()> {
        self.tray.borrow_mut().lock().unwrap().set_tooltip(tooltip)
    }
    ...
    pub fn set_title<S: AsRef<str>>(&mut self, title: Option<S>) {
        self.tray.borrow_mut().lock().unwrap().set_title(title)
    }

    /// Show or hide this tray icon
    pub fn set_visible(&mut self, visible: bool) -> Result<()> {
        self.tray.borrow_mut().lock().unwrap().set_visible(visible)
    }
    ...
    pub fn set_show_menu_on_left_click(&mut self, enable: bool) {
        ...
        self.tray.borrow_mut().lock().unwrap().set_show_menu_on_left_click(enable);
    ...
    pub fn rect(&mut self) -> Option<Rect> {
        self.tray.borrow_mut().lock().unwrap().rect()
    }
}
